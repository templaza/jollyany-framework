...
?>
<div class="hikashop_vote_form uk-form-stacked">
	<h5 class="hikashop_form_comment ui-corner-top"><?php echo JText::_('HIKASHOP_LET_A_COMMENT'); ?></h5>
<?php
if(hikashop_loadUser() == null) {
?>
    <div class="uk-margin">
        <label class="uk-form-label"><?php echo JText::_('HIKA_USERNAME'); ?>:</label>
        <div class="uk-form-controls"><input  type='text' name="pseudo_comment" class="uk-input" id='pseudo_comment' /></div>
    </div>
    <?php
    if ($row->email_comment == 1) {
        ?>
        <div class="uk-margin">
            <label class="uk-form-label"><?php echo JText::_('HIKA_EMAIL'); ?>:</label>
            <div class="uk-form-controls"><input  type='text' name="email_comment" class="uk-input" id='email_comment' value=''/></div>
        </div>
        <?php
    } else {
        ?>
...
?>
    ...
    if($row->vote_enabled == 1) {
        ?>
        <label class="hikashop_vote_stars uk-form-label uk-margin"><?php echo JText::_('VOTE'); ?>:
    ...
    <div class="uk-margin"><textarea type="text" name="hikashop_vote_comment" id="hikashop_vote_comment" class="hikashop_comment_textarea uk-textarea" placeholder="<?php echo JText::_('HIKASHOP_POST_COMMENT');?>"></textarea></div>
	<input class="uk-button uk-button-secondary" type="button" value="<?php echo JText::_('HIKASHOP_SEND_COMMENT'); ?>" onclick="hikashop_send_comment();"/>
</div>
