...
$limit  =   $this->params->get('jollyany_hikashop_description_limit', 100);
...
?>
    ...
    <div class="hikashop_product_desc uk-margin" itemprop="description"><?php
        echo mb_substr(strip_tags(preg_replace('#<hr *id="system-readmore" */>.*#is', '', $this->row->product_description)), 0, $limit, 'UTF-8') .'...' ;
        ?></div>
    <!-- EO DESCRIPTION -->
    <!-- ADD TO CART BUTTON -->
    <?php
