...
$jollyany_hikashop_margin_bottom    =   $this->params->get('jollyany_hikashop_margin_bottom', '');
$jollyany_hikashop_margin_bottom    =   $jollyany_hikashop_margin_bottom ? 'uk-margin-'. $jollyany_hikashop_margin_bottom .'-bottom' : 'uk-margin-bottom';
if ($this->params->get('module') == 'mod_hikashop') {
    $jollyany_hikashop_margin_bottom    =   '';
}
...
?>
			<div class="hkc-md-<?php echo (int)$span; ?> <?php echo $jollyany_hikashop_margin_bottom; ?> hikashop_category hikashop_category_column_<?php echo $current_column; ?> hikashop_category_row_<?php echo $current_row.$class; ?>">
