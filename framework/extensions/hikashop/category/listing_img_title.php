...
<div class="hikashop-category-image-title uk-margin-small <?php echo $this->params->get('module') == 'mod_hikashop' ? 'uk-child-width-auto' : 'uk-child-width-1-1'; ?> uk-grid-small" data-uk-grid>
    <div class="hikashop_category_image-container">
	<a href="<?php echo $this->row->link;?>" class="uk-link-reset" title="<?php echo $this->escape($this->row->category_name); ?>">
		<?php
