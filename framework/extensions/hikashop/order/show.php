...
?>
	<table class="hikashop_order_main_table uk-table uk-table-divider uk-table-justify">
		<tr>
			<td>
		...
		<tr>
			<td>
				<fieldset class="adminform" id="htmlfieldset_products">
					...
					<table class="uk-table uk-table-divider" cellpadding="1" width="100%">
						<thead>
							<tr>
...
<!-- EO WEIGHT -->
<!-- PRICE -->
								<td data-title="<?php echo JText::_('UNIT_PRICE'); ?>"><?php
									if($this->config->get('price_with_tax')) {
...
<!-- EO PRICE -->
<!-- QUANTITY -->
								<td data-title="<?php echo JText::_('PRODUCT_QUANTITY'); ?>"><?php
...
<!-- EO TOTAL WEIGHT -->
<!-- TOTAL PRICE -->
								<td data-title="<?php echo JText::_('PRICE'); ?>"><?php
									if($this->config->get('price_with_tax')) {
