...
<div id="hikashop_checkout_coupon_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" data-checkout-step="<?php echo $this->step; ?>" data-checkout-pos="<?php echo $this->module_position; ?>" class="hikashop_checkout_coupon uk-card uk-card-default uk-card-body uk-margin">
<?php } ?>
...
?>
            <fieldset class="uk-fieldset uk-form-stacked">
                <label for="hikashop_checkout_coupon_input_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" class="uk-form-label"><?php echo JText::_('HIKASHOP_ENTER_COUPON'); ?></label>
                <div class="uk-form-controls uk-button-group">
                    <input class="hikashop_checkout_coupon_field uk-input" id="hikashop_checkout_coupon_input_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" type="text" name="checkout[coupon]" value=""/>
                    <button type="submit" onclick="return window.checkout.submitCoupon(<?php echo $this->step.','.$this->module_position; ?>);" class="<?php echo $this->config->get('css_button','hikabtn'); ?> uk-button uk-button-primary hikabtn_checkout_coupon_add"><?php
                        echo JText::_('ADD');
                        ?></button>
                </div>
            </fieldset>
