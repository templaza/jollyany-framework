...
if(empty($this->ajax)) {
?>
<div id="hikashop_checkout_login_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" data-checkout-step="<?php echo $this->step; ?>" data-checkout-pos="<?php echo $this->module_position; ?>" class="hikashop_checkout_login uk-card uk-card-default uk-margin">
<?php
}
?>
<?php
...
<?php
	...
	if(!empty($title))
		echo '<div class="uk-card-header"><h3>'.JText::_($title).'</h3></div>';
...
?>
	<div class="uk-card-body"><div data-uk-grid>
