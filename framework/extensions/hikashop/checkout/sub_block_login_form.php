...
<!-- OLD USERNAME -->
	<div class="hkform-group control-group hikashop_login_username_line">
		...
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="text" id="username" name="login[username]" class="uk-input" alt="<?php echo JText::_('HIKA_USERNAME') ?>" size="18" />
		</div>
	</div>
<!-- EO OLD USERNAME -->
<!-- OLD PASSWORD -->
	<div class="hkform-group control-group hikashop_login_password_line">
		...
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="password" id="passwd" name="login[passwd]" class="uk-input" size="18" alt="<?php echo JText::_('HIKA_PASSWORD') ?>" />
		</div>
	</div>
<!-- EO OLD PASSWORD -->
<!-- OLD REMEMBER ME -->
