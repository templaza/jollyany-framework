...
<div id="hikashop_checkout_cart_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" data-checkout-step="<?php echo $this->step; ?>" data-checkout-pos="<?php echo $this->module_position; ?>" class="hikashop_checkout_cart uk-card uk-card-default uk-card-body uk-margin">
<?php } ?>
<?php
	$this->checkoutHelper->displayMessages('cart');
?>
<table class="uk-table uk-table-divider uk-table-responsive uk-table-middle uk-table-justify">
	<thead>
		<tr>
<?php
	$row_count = 2;
...
?>
				<div class="hikashop_cart_product_image_thumb uk-width-small"><?php
...
<!-- NAME -->
		...
		if(!empty($this->options['show_product_code'])) {
			?><span class="hikashop_product_code_checkout uk-text-meta"><?php
