...
<!-- NEXT BUTTON -->
		<button id="hikabtn_checkout_next" type="submit" class="<?php echo $this->config->get('css_button','hikabtn'); ?> uk-button uk-button-secondary" onclick="return window.checkout.submitStep(this);"><?php
